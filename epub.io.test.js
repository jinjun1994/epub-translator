...
import {createEpub, readEpub} from "./epub-io.js";
 ...
 const EPUB_TO_BE_CREATED_URL = normalizeRelativePath("./src/test/test_epub_gen.epub");
...
function normalizeRelativePath(relativePath) {
...

 {
    (async () => {
      console.log('given');
        // given
        const BOOK_URL = normalizeRelativePath("./src/test/GeographyofBliss_oneChapter.epub");
